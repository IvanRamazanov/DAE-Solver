...
/**
 * Переменные: i.N - ток; p.N - потенциал; X.N - перем состояния;
 * d.X.N - производная; O.N - выход; I.N - вход.
 * @author Иван
 */
public class StringGraph {
    ...
    public StringGraph(String function){  //пропадают индексы Х
        variables=new HashSet();
...
//        }
    ...
    void invertUzel(Uzel next,int refIndex){
        ...
        //МОЖЕТ БЫТЬ ФУНКЦИЯ, И ТОГДА НЕ ВСЕ ТАК ПРОСТО
